\documentclass[12pt]{article} % Choose the document class and font size
\usepackage[margin=0.75in]{geometry} % Page layout settings
...
\newfontfamily{\faFreeSolid}{Font Awesome 6 Free Solid}
\newfontfamily{\faFreeRegular}{Font Awesome 6 Free Regular}
\newcommand{\faIcon}[2]{{\csname fa#1\endcsname\symbol{"#2}}}


\newfontfamily{\ai}{Academicons}

% 手动根据 Unicode 编码定义图标（这些编码在官网可以查到）
\newcommand{\aiStata}{{\ai \symbol{"E944}}}   % Stata 的编码
\newcommand{\aiMatlab}{{\ai \symbol{"E93B}}}  % Matlab 的编码
\newcommand{\aiOrcid}{{\ai \symbol{"E953}}}   % ORCID 编码
...
\newcommand{\mytitle}[5]{
  \begin{center}
    ...
    \href{mailto:#2}{\faEnvelope\,#2} % Email with mailto: link
    \href{mailto:#3}{\faEnvelope\,#3} \\ % Email with mailto: link    
    \href{#4}{\faGithub\,#4} \\ % Website with link
    \href{https://orcid.org/#5}{{\ai }\,#5} % Website with link
  \end{center}
}
%%% ----------------------------- %%%
...
\mytitle{Tianlei Zhang \\ \normalsize{\textnormal{/tee-ahn-lay jahng/}}}{zhangtianlei@whu.edu.cn}{zhangtianlei.cn@gmail.com}{ ynbsztl.github.io} % Insert your custom title
{0009-0006-0045-1487}
...
\section*{\faBullseye\,Research Interests}\label{ri}
...
\section*{{\ai \,\,}\, Publications}
\label{pubs}

% Add equal contribution dagger
\vspace{-.75em}

{\ai }\,~\href{https://scholar.google.com/citations?hl=zh-CN&user=zsO6zkYAAAAJ}{\small Google Scholar page}\\
...
\section*{\faGears\, Skills \& Languages}
\label{tools}
\input{tools.tex}
...
\medskip
Last updated: \today. \href{https://ynbsztl.github.io/ztlcv/CV_Tianlei.pdf}{[\faFilePdfO\,updating version]}
